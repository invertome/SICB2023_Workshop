## Replace "nau" and "nautilus" with gene abbreviation/name
## "crustome.pep" is simply all the translated transcriptomes concatenated together
## adjust cpu and thread numbers accordingly
## dependencies: mafft, hmmer, seqtk, clipkit, iqtree2, treeshrink
